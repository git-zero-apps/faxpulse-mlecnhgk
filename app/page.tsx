    ...
    <div className="bg-[#0a0a0f] text-gray-100 min-h-screen relative">
      ...
      <nav className="animate-fade-in sticky top-0 z-50 bg-[#0a0a0f]/80 backdrop-blur-xl border-b border-white/5">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          <span className="text-xl font-display font-extrabold text-white">FaxPulse</span>
      ...
      <section className="relative mx-auto max-w-4xl px-6 pt-24 pb-32 text-center">
        ...
        <h1 className="animate-fade-up [animation-delay:150ms] font-display text-5xl font-extrabold tracking-tight text-white sm:text-6xl lg:text-7xl" style={{ lineHeight: "1.08" }}>
          Every Fax. One Dashboard. Zero Hardware.
        </h1>
        <p className="animate-fade-up [animation-delay:350ms] mt-6 text-lg text-gray-400 sm:text-xl max-w-2xl mx-auto leading-relaxed">
          Send and receive faxes from your browser — no machines, no phone lines, no hassle.
        </p>
      ...
      <section id="features" className="bg-[#0a0a0f] py-24">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-center font-display text-3xl font-bold text-white mb-4">Everything You Need to Replace Your Fax Machine</h2>
          <p className="text-center text-gray-400 mb-16 max-w-xl mx-auto">
            Professional faxing without the legacy equipment — just upload, send, and track delivery in real-time.
          </p>
          ...
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            ...
            <h3 className="text-lg font-semibold text-white">send-fax-upload</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your send-fax-upload with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">receive-faxes</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your receive-faxes with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">contact-book</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your contact-book with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">cover-page-templates</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your cover-page-templates with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">fax-status-tracking</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your fax-status-tracking with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">dedicated-fax-numbers</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your dedicated-fax-numbers with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">team-member-access</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your team-member-access with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <h3 className="text-lg font-semibold text-white">usage-quota-tracking</h3>
            <p className="mt-2 text-sm text-gray-400">Manage your usage-quota-tracking with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            <p className="mt-2 text-sm text-gray-400">Manage your subscription-billing with ease using our intuitive interface.</p>
          </div>
          <div className="group rounded-2xl bg-white/[0.03] backdrop-blur-sm border border-white/[0.06] hover:border-brand-500/30 transition-colors p-8">
            <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500/10 text-brand-500">
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-400 max-w-xl mx-auto">
            Start sending and receiving faxes today with 5 free pages — no credit card required.
          </p>
          <div className="mt-10">
            <Link
              href="/login"
      ...
      <footer className="border-t border-white/5 py-12">
        <div className="mx-auto max-w-6xl px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-sm text-gray-500">&copy; {new Date().getFullYear()} FaxPulse. All rights reserved.</span>
